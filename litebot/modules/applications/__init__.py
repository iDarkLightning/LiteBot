...
def setup(bot):
    account = service_account(path.join(getcwd(), "litebot", "modules", MODULE_NAME,
                                        "../../../plugins/standard/applications/creds.json"))
...
def requirements(bot: LiteBot):
    ...
    return config_met and path.exists(path.join(getcwd(), "litebot", "modules", MODULE_NAME,
                                                "../../../plugins/standard/applications/creds.json"))